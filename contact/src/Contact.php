...
class Contact extends Plugin
{
    ...
    public function init()
    {
        ...
        $myModule = Craft::$app->getModule('my-module');
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'contact/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'contact/default/do-something';
            }
        );
